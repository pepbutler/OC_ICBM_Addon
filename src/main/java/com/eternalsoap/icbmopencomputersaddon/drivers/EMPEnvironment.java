...
// through the component list, returns true iff s == \"component_emp_tower\"")
...
//    }
//
//    @Callback(doc = "function():boolean -- Activate the EMP Tower, returns true if it successfully
...
//    }
//
//    @Callback(doc = "function():number -- Gets the mode of the EMP Tower, 0 = Both, 1 = Missile, 2
// =  Energy")
//    public Object[] getMode(final Context context, final Arguments args) {
//        return new Object[]{tileEntity.empMode};
//    }
//
//    @Callback(doc = "function(mode:number):number -- Set the mode of the EMP Tower, 0 = Both, 1 =
// Missile, 2 = Energy")
