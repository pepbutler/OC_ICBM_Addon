...
// through the component list, returns true iff s. == \"component_cruise_launcher\"")
...
//    }
//
//    @Callback(doc = "function(x: number, y: number, z: number) -- Set the X & Y & Z coordinate of
// the target position")
//    public Object[] setTargetPos(final Context context, final Arguments args) {
//        tileEntity.setTarget(new Pos(args.checkInteger(0), args.checkInteger(1),
// args.checkInteger(2)));
//        return null;
//    }
//
